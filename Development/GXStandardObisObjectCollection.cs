...
namespace Gurux.DLMS
{
    ...
    class GXStandardObisCodeCollection : List<GXStandardObisCode>
    {
        ...
        /// <param name="str"></param>
        /// <returns></returns>
        static string GetSaudiArabiaDescription(string str)
        {
            if (string.IsNullOrEmpty(str) || str[0] != '$')
            {
                return "";
            ...
            switch (value)
            {
                ...
                case 3:
                    return "Sum Li Reactive energy+ (QI+QII)";
                case 4:
                    return "Sum Li Reactive energy- (QIII+QIV)";
                case 5:
                    return "Sum Li Reactive energy QI";
                case 6:
                    return "Sum Li Reactive energy QII";
                case 7:
                    return "Sum Li Reactive energy QIII";
                case 8:
                    return "Sum Li Reactive energy QIV";
                case 9:
                    return "Sum Li Apparent energy+ (QI+QIV)";
                case 10:
                    return "Sum Li Apparent energy- (QII+QIII)";
                case 11:
                ...
                case 22:
                    return "L1 Active energy- (QII+QIII)";
                case 23:
                    return "L1 Reactive energy+ (QI+QII)";
                case 24:
                    return "L1 Reactive energy- (QIII+QIV)";
                case 25:
                    return "L1 Reactive energy QI";
                case 26:
                    return "L1 Reactive energy QII";
                case 27:
                    return "L1 Reactive energy QIII";
                case 28:
                    return "L1 Reactive energy QIV";
                case 29:
                    return "L1 Apparent energy+ (QI+QIV)";
                case 30:
                    return "L1 Apparent energy- (QII+QIII)";
                case 31:
                    return "L1 Current";
                case 32:
                    return "L1 Voltage";
                ...
                case 42:
                    return "L2 Active energy- (QII+QIII)";
                case 43:
                    return "L2 Reactive energy+ (QI+QII)";
                case 44:
                    return "L2 Reactive energy- (QIII+QIV)";
                case 45:
                    return "L2 Reactive energy QI";
                case 46:
                    return "L2 Reactive energy QII";
                case 47:
                    return "L2 Reactive energy QIII";
                case 48:
                    return "L2 Reactive energy QIV";
                case 49:
                    return "L2 Apparent energy+ (QI+QIV)";
                case 50:
                    return "L2 Apparent energy- (QII+QIII)";
                case 51:
                    return "L2 Current";
                case 52:
                    return "L2 Voltage";
                ...
                case 62:
                    return "L3 Active energy- (QII+QIII)";
                case 63:
                    return "L3 Reactive energy+ (QI+QII)";
                case 64:
                    return "L3 Reactive energy- (QIII+QIV)";
                case 65:
                    return "L3 Reactive energy QI";
                case 66:
                    return "L3 Reactive energy QII";
                case 67:
                    return "L3 Reactive energy QIII";
                case 68:
                    return "L3 Reactive energy QIV";
                case 69:
                    return "L3 Apparent energy+ (QI+QIV)";
                case 70:
                    return "L3 Apparent energy- (QII+QIII)";
                case 71:
                    return "L3 Current";
                case 72:
                    return "L3 Voltage";
                    ...
                    if (tmp2.Length > 1)
                    {
                        ...
                        if (obisCode != null && string.Compare("$1", tmp2[1].Trim()) == 0)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    desc = GetSaudiArabiaDescription("$" + obisCode[2]);
                                }
                                else
                                {
