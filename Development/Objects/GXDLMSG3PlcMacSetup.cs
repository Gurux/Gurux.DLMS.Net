...
namespace Gurux.DLMS.Objects
{
    ...
    public class GXDLMSG3PlcMacSetup : GXDLMSObject, IGXDLMSBase
    {
        ...
        void IGXDLMSBase.Save(GXXmlWriter writer)
        {
            ...
            writer.WriteElementString("MacBroadcastMaxCwEnabled", MacBroadcastMaxCwEnabled);
            writer.WriteElementString("MacTransmitAtten", MacTransmitAtten);
            SaveMacPosTable(writer);
            writer.WriteElementString("MacDuplicateDetectionTtl", MacDuplicateDetectionTtl);
        }
