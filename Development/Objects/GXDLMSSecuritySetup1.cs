...
namespace Gurux.DLMS.Objects
{
    ...
    /// </summary>
    public class GXDLMSSecuritySetup1 : GXDLMSSecuritySetup, IGXDLMSBase
    {
        ...
        public GXDLMSSecuritySetup1(string ln)
        : this(ln, 0)
        {
        }
        ...
        public GXDLMSSecuritySetup1(string ln, ushort sn)
        : base(ln, sn)
        {
            Version = 1;
        ...
        /// </summary>
        [XmlIgnore()]
        public new SecurityPolicy1 SecurityPolicy
        {
            get;
            set;
        }
        ...
        /// </summary>
        [XmlIgnore()]
        public new SecuritySuite SecuritySuite
        {
            get;
            set;
        }
        ...
        byte[] IGXDLMSBase.Invoke(GXDLMSSettings settings, ValueEventArgs e)
        {
            try
            {
                if (e.Index == 1)
                {
                    SecurityPolicy = (SecurityPolicy1)e.Parameters;
                }
                else if (e.Index == 2)
                {
        ...
        private static void RemoveCertificate(GXDLMSSettings settings, ValueEventArgs e)
        {
        ...
        private static void ImportCertificate(GXDLMSSettings settings, ValueEventArgs e)
        {
        ...
        private static byte[] ExportCertificate(GXDLMSSettings settings, ValueEventArgs e)
        {
        ...
        private byte[] GenerateCertificateRequest(GXDLMSSettings settings, ValueEventArgs e)
        {
            ...
            if (kp.Key != null)
            {
                GXPkcs10 pkc10 = GXPkcs10.CreateCertificateSigningRequest(kp, GXAsn1Converter.SystemTitleToSubject(settings.Cipher.SystemTitle));
        ...
        void IGXDLMSBase.SetValue(GXDLMSSettings settings, ValueEventArgs e)
        {
            switch (e.Index)
            {
                case 1:
                    ...
                    break;
                case 2:
                    SecurityPolicy = (SecurityPolicy1)Convert.ToByte(e.Value);
                    break;
                case 3:
        ...
        {
            SecurityPolicy = (SecurityPolicy1)reader.ReadElementContentAsInt("SecurityPolicy");
