...
public class GXDLMSIEC14908Identification : GXDLMSObject, IGXDLMSBase
{
    ...
    void IGXDLMSBase.SetValue(GXDLMSSettings settings, ValueEventArgs e)
    {
        ...
        else if (e.Index == 4)
        {
            ...
            {
                DomainId = GXDLMSClient.ChangeType((byte[])e.Value, DataType.OctetString).ToString();
            }
        }
        else if (e.Index == 5)
        {
            ...
            {
                ProgramId = GXDLMSClient.ChangeType((byte[])e.Value, DataType.OctetString).ToString();
            }
        }
        else if (e.Index == 6)
        {
            ...
            {
                UniqueNodeId = GXDLMSClient.ChangeType((byte[])e.Value, DataType.OctetString).ToString();
            }
        }
        else
        {
