...
Gurux.DLMS library for .NET is a high-performance c# component that helps you to read you DLMS/COSEM compatible electricity, gas or water meters. We have try to make component so easy to use that you do not need understand protocol at all.
...
You can report the [issues](https://www.gurux.fi/project/issues/gurux.dlms.net). 
...
You can get [source codes](https://www.github.com/gurux/gurux.dlms.net)
